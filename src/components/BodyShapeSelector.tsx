...
const patternSquare = "/img/pattern-square.svg";
const patternDots = "/img/pattern-dots.svg";
const patternRounded = "/img/pattern-rounded.svg";
const patternDiamond = "/img/pattern-diamond.svg";
const patternClassy = "/img/pattern-classy.svg";
